...
class SessionStatsBloc extends Bloc<SessionStatsEvent, SessionStatsState> {
  ...
  Future<void> _onSaveSessionToAppwrite(
    ...
    final session = InterviewSession(
      ...
      type: InterviewType.mcq, // Default or passed from event
      difficulty: DifficultyLevel.medium, // Default or passed from event
  ...
  Future<void> _onLoadAllSessions(
    ...
    final mockSessions = [
      InterviewSession(
        ...
        feedback: 'Great performance! You showed strong technical knowledge.',
      ),
      InterviewSession(
        sessionId: 'session_2',
        userId: userId,
